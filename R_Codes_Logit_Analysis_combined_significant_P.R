...
#Upload the file: Logit_Analysis_combined_significant_P.csv
mydata<-read.csv(file="Logit_Analysis_combined_significant_P.csv",head=TRUE,sep=",")

#Create an output file: Output_Logit_Analysis_Fall2016.txt
...
mylogit3 <- glm(formula=Behavior2 ~ Semester+Grade+Gender+Category+Required, family = "binomial");
summary(mylogit3)
